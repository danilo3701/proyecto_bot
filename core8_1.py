...
init_my_words(CONTACT_URL, MATERIALS_POST_URL)  # 💬 пробрасываем ссылки в модуль «Мои слова»
...
from my_words_section import my_words_router, init_my_words  # 💬 подключаем отдельный модуль «Мои слова»
dp.include_router(my_words_router)  # 💬 регистрируем router
...
@dp.callback_query(LessonStates.choosing_category, F.data.startswith("menu:"), F.data != "menu:mywords")  # 💬 отдаём menu:mywords в router «Мои слова»
@track_handler
